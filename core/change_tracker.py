...
class ChangeTracker:
    ...
    def _count_changed_lines(self, original_lines: list[str],
                           modified_lines: list[str]) -> int:
    ...
    def _estimate_performance_gains(self, original: str, modified: str) -> float:
        ...
        if '[' in modified and 'for' in modified and original.count('append') > modified.count('append'):
