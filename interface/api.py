...
class APIInterface:
    ...
    def start_refactor_endpoint(self, request_data: dict[str, Any]) -> dict[str, Any]:
        ...
        try:
            ...
            if not target_path:
                return {"error": {"code": "INVALID_REQUEST", "message": "target_path required"}}, 400
    ...
    def get_status_endpoint(self, refactor_id: str) -> dict[str, Any]:
        ...
        try:
            ...
            return {"error": {"code": "INVALID_ID", "message": "Invalid session ID format"}}, 400
    ...
    def cancel_session_endpoint(self, refactor_id: str) -> dict[str, Any]:
        ...
        try:
            ...
            if success:
                ...
                return {"error": {"code": "CANCELLATION_FAILED", "message": "Failed to cancel session"}}, 400
